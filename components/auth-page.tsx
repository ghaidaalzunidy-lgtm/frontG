...
export function AuthPage() {
  ...
  // HR and admin can only sign in (no signup). Force login mode if they're in signup.
  useEffect(() => {
    if ((userType === "hr" || userType === "admin") && authMode === "signup") {
      setAuthMode("login");
    }
  }, [userType, authMode, setAuthMode]);
                ...
                <AnimatePresence mode="wait">
                  {step === "select-role" ? (
                    ...
                    >
                      ...
                      {/* Toggle Auth Mode - hidden for HR and admin */}
                      {userType === "employee" && (
